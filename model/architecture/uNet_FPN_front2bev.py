...
def joiner(encoder_layers, thetas, kernel_size=(3,3), activation=tf.nn.relu, batch_norm=True):
    ...
    t = SpatialTransformer(shape, shape, theta_init=thetas, theta_const=True)(encoder_layers[1])
    ...
    t = SpatialTransformer(shape, shape, theta_init=thetas, theta_const=True)(encoder_layers[2])
    ...
    t = SpatialTransformer(shape, shape, theta_init=thetas, theta_const=True)(encoder_layers[3])
    ...
    t = SpatialTransformer(shape, shape, theta_init=thetas, theta_const=True)(encoder_layers[4])
